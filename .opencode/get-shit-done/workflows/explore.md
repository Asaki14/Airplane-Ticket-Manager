...
```bash
node "/Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
