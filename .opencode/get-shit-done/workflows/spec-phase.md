...
```bash
INIT=$(node "/Users/wangyao/Desktop/Vibe-coding/Airplane-Ticket-Manager/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/wangyao/Desktop/Vibe-coding/Airplane-Ticket-Manager/.opencode/get-shit-done/templates/spec.md.
