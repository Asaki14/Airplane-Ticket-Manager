...
```
Task(
  prompt="Read /Users/wangyao/Desktop/Vibe-coding/Airplane-Ticket-Manager/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/wangyao/Desktop/Vibe-coding/Airplane-Ticket-Manager/.opencode/get-shit-done/templates/SECURITY.md`
