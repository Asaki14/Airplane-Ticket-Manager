...
Use template from `/Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
