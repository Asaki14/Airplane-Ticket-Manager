...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode
                  → checks /Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done
                  → writes to /Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/hooks/
...
@/Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/wangyao/Desktop/Airplane-Ticket-Manager/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
