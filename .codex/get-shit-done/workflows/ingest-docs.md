...
```bash
INIT=$(node "/Users/wangyao/Desktop/Vibe-coding/Airplane-Ticket-Manager/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/wangyao/Desktop/Vibe-coding/Airplane-Ticket-Manager/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
